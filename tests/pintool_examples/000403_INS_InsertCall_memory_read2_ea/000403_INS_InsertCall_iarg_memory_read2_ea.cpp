...
VOID instr_read2(ADDRINT ins_addr, THREADID tid,  ADDRINT address_of_read2 ) { 
  ...
  std::cout << "ADDRESS OF READ: "  << address_of_read2 << std::endl << std::flush;
  std::cout << "===================================================="<< std::endl << std::flush;
}
...
VOID Instruction(INS ins, VOID *v)
{
  ...
  /* } */
   if (INS_HasMemoryRead2(ins) ) {
    ...
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)instr_read2, IARG_ADDRINT, ins_addresss, IARG_THREAD_ID, IARG_MEMORYREAD2_EA,  IARG_END);
  }
